...
export default function Settings() {
    ...
    return (
        <div className="flex justify-center items-center h-[calc(100vh-100px)] w-full">
            <div className="w-[1000px] h-[550px] bg-bg rounded-[40px] shadow-2xl flex-col items-center justify-center relative">
                <div className="w-full h-[100px] border-b-2 border-b-accent rounded-t-[40px] pl-3 pb-3 bg-bgDark hover:bg-accent sticky top-0 left-0 transition-all duration-300">
                                               
                    <div className="flex flex-row items-center gap-4">
                        <h1 className="text-[40px]  font-bold text-text">Account Settings</h1>
                    </div>
                    <p className="text-textMuted text-sm ">You can manage your Profile simply in here...</p>
                                                
                </div>
                <div className="mt-5 gap-5 flex flex-row justify-center items-center ">
                    <div className="w-[450px] h-[410px] rounded-[40px] bg-bgLight shadow-2xl flex flex-col justify-center items-center relative">
                        ...
                        <button onClick={updateProfile} className="w-[300px] h-[50px] absolute bottom-3 flex justify-center items-center  rounded-full text-yellow border border-yellow hover:border-none hover:bg-yellow/30 uppercase tracking-[5px] transition-all duration-300">Update Profile</button>
                    ...
                    <div className="w-[450px] h-[410px] rounded-[40px] bg-bgLight shadow-2xl flex flex-col justify-center items-center relative">
                        ...
                        <button onClick={updatePassword} className="w-[300px] h-[50px] absolute bottom-3 flex justify-center items-center  rounded-full text-yellow border border-yellow hover:border-none hover:bg-yellow/30 uppercase tracking-[5px] transition-all duration-300">Update Password</button>
                    </div>
                </div>
            </div>
        </div>
